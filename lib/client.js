/**
 * dsh-animated-bg — client bundle (v2, self-contained).
 *
 ...
 * settings. The card is fully self-contained — it reads/writes localStorage
 * and IndexedDB directly and never depends on injected business props.
 *
 * Storage:
    ...
    function AnimatedBgRow(props) {
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            "button", { className: "dsh-animated-bg-btn", onClick: onClear },
            t("clear")
          )
        ),
        React.createElement(
