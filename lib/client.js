  ...
  factory: (require) => {
    ...
    function applyTone(mode, cb) {
      ...
      var finish = function (primary) {
        ...
        // frosted-glass blur on the sidebar when it is translucent
        if (typeof document !== "undefined") {
          if (glass) document.documentElement.setAttribute("data-dsh-sidebar-glass", "1");
          else document.documentElement.removeAttribute("data-dsh-sidebar-glass");
        }
    ...
    /** Set the sidebar transparency (0 = opaque, 0.8 = most transparent). */
    function setSidebarTransparency(transparency) {
      var alpha = 1 - Math.max(0, Math.min(0.8, Number(transparency) || 0));
    ...
    function clearTone() {
      ...
      toneStatus = "";
      if (typeof document !== "undefined") {
        document.documentElement.removeAttribute("data-dsh-sidebar-glass");
      }
    }
    ...
    var cssText =
      ...
      "html[data-dsh-sidebar-glass] [class*=sidebarCol]{backdrop-filter:blur(14px);-webkit-backdrop-filter:blur(14px)}" +
    ...
    function AnimatedBgRow(props) {
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement("span", null, Math.round(cfg.sidebarTrans * 100) + "%")
        ),
